 ...
 */
public class DayTransDB<T> extends AbstractCursorItemReader<T> {
	...
	public DayTransDB() {
		super();
		setName(ClassUtils.getShortName(DayTransDB.class));
	}
...
//	}
	...
	protected void openCursor(Connection con) {
		try {
			str=sql;
			str = str.replace("?", DayTransBatchService.tradeTime);
