package com.yihuacomputer.fish.batch.entity;
...
import com.yihuacomputer.fish.api.batch.base.ITransactionMonths;
...
public class TransactionMonths implements ITransactionMonths {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "SEQ_ATMC_TRANSACTION_MONTHS")
	@SequenceGenerator(name = "SEQ_ATMC_TRANSACTION_MONTHS", sequenceName = "SEQ_ATMC_TRANSACTION_MONTHS")
	@Column(name = "ID")
	private long id;
