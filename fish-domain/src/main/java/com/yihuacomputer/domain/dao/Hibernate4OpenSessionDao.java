 ...
 *
 */
package com.yihuacomputer.domain.dao;
...
public class Hibernate4OpenSessionDao implements IGenericDao {

	private final Logger logger = LoggerFactory.getLogger(Hibernate4OpenSessionDao.class);
...
class FilterHql21 {
	...
	public FilterHql21(IFilter outerFilter) {
		IFilter filter = null;
		if (outerFilter == null) {
			filter = new Filter();
		} else {
