...
public class AtmModuleServiceTest extends BindSessionInTest2{
	...
	public void test(){
		...
		atmModuleService.remove(module2.getNo());
		Iterable<IAtmModule> listRemove1 = atmModuleService.list();
		List<IAtmModule> removeLists1 = new ArrayList<IAtmModule>();
		for(IAtmModule item : listRemove1){
