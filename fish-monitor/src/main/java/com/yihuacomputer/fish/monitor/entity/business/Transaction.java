...
public class Transaction implements ITransaction {
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "SEQ_ATMC_TRANSACTION")
    @SequenceGenerator(name = "SEQ_ATMC_TRANSACTION", sequenceName = "SEQ_ATMC_TRANSACTION")
    @Column(name = "ID")
    private long id;
