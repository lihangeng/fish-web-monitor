...
import com.yihuacomputer.fish.report.engine.scheduler.EveryMonthFault;
...
public class ReportEngineModule {
	...
	@Bean(name = "EveryMonthFault")
	public EveryMonthFault everyMonthFault() {
		return new EveryMonthFault();
	}
