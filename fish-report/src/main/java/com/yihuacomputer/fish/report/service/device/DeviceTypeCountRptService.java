...
//    private String countName ;
    ...
    public List<IDeviceTypeCountJRpt> listDeviceTypeCountJReport(IFilter filter) {
        ...
        List<Object> list = dao.findByHQL(hql.toString(), valueObj.toArray());
        List<IDeviceTypeCountJRpt> deviceTypeList = new ArrayList<IDeviceTypeCountJRpt>();
        String countName = messageSource.getMessage("report.devTypeCount.countName", null, FishCfg.locale);
        for (Object obj : list) {
            Object[] o = (Object[]) obj;
            DeviceTypeCountJRpt deviceTypeCount = new DeviceTypeCountJRpt();
