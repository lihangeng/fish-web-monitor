...
public class Organization implements IOrganization {
	...
	@OneToMany(mappedBy = "parent", fetch = FetchType.EAGER, targetEntity = com.yihuacomputer.fish.person.entity.Organization.class)
	private final List<Organization> children = new ArrayList<Organization>();

	@ManyToOne(fetch = FetchType.EAGER, targetEntity = com.yihuacomputer.fish.person.entity.Organization.class)
