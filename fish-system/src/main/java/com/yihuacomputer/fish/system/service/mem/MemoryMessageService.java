...
import com.yihuacomputer.fish.system.service.base.DomainMessageService;

@Service
public class MemoryMessageService extends DomainMessageService{
	...
	private List<Message> entities = new ArrayList<Message>();
