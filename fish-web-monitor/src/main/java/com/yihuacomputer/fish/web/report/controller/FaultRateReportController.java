...
public class FaultRateReportController {
	 ...
	 public @ResponseBody ModelMap queryFaultByBrand(){
		 ...
		 data.add(new BrandForm("YH",100,10000,34));
		 data.add(new BrandForm("HW",200,20000,56));
		 data.add(new BrandForm("ZX",300,30000,26));
		 data.add(new BrandForm("TX",400,40000,84));
	 ...
	 public @ResponseBody ModelMap queryFaultByType(){
		 ...
		 data.add(new TypeForm("cds6040w",400,40000,20));
		 data.add(new TypeForm("cds6040t",300,30000,50));
		 data.add(new TypeForm("cds6040wt",200,20000,67));
		 data.add(new TypeForm("cds6040tw",100,10000,84));
	        model.put(FishConstant.DATA, data);
	        model.put(FishConstant.SUCCESS, true);
		return model;
