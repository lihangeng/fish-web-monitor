Ext
		.apply(
				EwayLocale,
				{
					...
					quartz : {
						timingJob:'Timing Job',//EwayLocale.quartz.timingJob
						pauseSucceed : 'Pause Succeed',// EwayLocale.quartz.pauseSucceed
						pauseFail : 'Pause Fail',// EwayLocale.quartz.pauseFail
						selectJob : ' Please Select Want To Operate Job',// EwayLocale.quartz.selectJob
						recoverSucceed : 'Recover Succeed',// EwayLocale.quartz.recoverSucceed
						recoverFail : 'Recover Fail',// EwayLocale.quartz.recoverFail
						deleteSucceed : 'Delete Succeed',// EwayLocale.quartz.deleteSucceed
						deleteFail : 'Delete Fail',// EwayLocale.quartz.deleteFail
						executeSucceed : 'Execute Succeed',// EwayLocale.quartz.executeSucceed
						executeFail : 'ExecuteFail',// EwayLocale.quartz.executeFail
