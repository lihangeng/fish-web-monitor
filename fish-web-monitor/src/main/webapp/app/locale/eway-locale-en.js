...
//			massExport:'批量导入',
		...
		agent:{
			remote:{
				...
				distanceExplorer:'Remote browse:',//远程浏览
				distanceExplorerFailure:'Browse failed.',//远程浏览失败
		...
		person:{
			...
			bankPer :{
				title:'Person',//Eway.locale.person.bankPer.title 银行人员管理
		...
		machine:{
			...
			atmGroup : {
				...
				comboxAwayFlag:{
					...
					clickBank:'Outside self-service'//单机离行自助服务点
				},
