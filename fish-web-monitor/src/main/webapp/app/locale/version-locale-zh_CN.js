Ext.apply(EwayLocale,{
	...
	versionType : {//EwayLocale.versionType.versionType
		...
		versionTypeNameRegText : '只能输入1-30个字符,字符为:字母(a-z或A-Z)、数字(0-9)、下划线(_)、横线(-)'//EwayLocale.versionType.versionTypeNameRegText
	},
	statics : {
	...
	version : {//EwayLocale.version.version
		...
		installPath:'安装路径',//EwayLocale.version.installPath
		View : {
			title : '版本管理',//EwayLocale.version.View.title
			...
			versionStatusEmptyText : '全部',//EwayLocale.version.View.versionStatusEmptyText
			...
			autoUpdateEmptyText : '全部',//EwayLocale.version.View.autoUpdateEmptyText
			...
			job : {
				...
				scheduler : '计划中',//EwayLocale.version.View.job.scheduler
				ready : '准备运行',//EwayLocale.version.View.job.ready
				pause : '暂停',//EwayLocale.version.View.job.pause
				complete : '完成'//EwayLocale.version.View.job.complete
			}
		},
		VersionInstallInfo : {
			title : '版本安装信息统计图'//EwayLocale.version.VersionInstallInfo.title
		},
		jobPriority : {
		...
		jobType : {
			Manual : '手工作业',//EwayLocale.version.jobType.Manual
