Ext.define('Eway.view.machine.detail.run.RetainCardInfo', {
    extend: 'Ext.Panel',
	...
	tools:[{
	    ...
	    handler: function(event, toolEl, panelHeader) {
	     	this.up('retainCardInfo').down('cartesian').getStore().load();
	    }
	}],

    initComponent: function() {
        var me = this;
        me.myDataStore = Ext.create('Eway.store.machine.detail.RetainCard');
//        me.myDataStore.load();
        me.items = [{
            xtype: 'cartesian',
            width: '100%',
