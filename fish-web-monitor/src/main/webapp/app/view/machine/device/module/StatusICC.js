Ext.define("Eway.view.machine.device.module.StatusICC", {
	extend : 'Ext.form.Panel',
	alias : 'widget.machine_device_module_statusicc',
	defaults : {
		border : false
	},
	initComponent : function() {
		Ext.apply(this, {
			...
			items : [ {
				...
				title : EwayLocale.machine.device.ICCStatus,
				titleAlign:'center',
				layout : 'column',
				border : 'false',
				items : [ {
					...
					items : [ {
						...
						fieldLabel : EwayLocale.machine.device.cardsAccount,
						name : 'cardsAccount',
						style : 'margin-top:2px'
					}*/ ]
				} ]
