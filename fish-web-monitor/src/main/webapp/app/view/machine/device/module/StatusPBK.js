Ext.define("Eway.view.machine.device.module.StatusPBK", {
	extend : 'Ext.form.Panel',
	alias : 'widget.machine_device_module_statuspbk',
	defaults : {
		border : false
	},
	initComponent : function() {
		Ext.apply(this, {
			...
			items : [ {
				...
				title : '<center>'+EwayLocale.machine.device.PBKStatus+'</center>',
				layout : 'column',
				border : 'false',
				items : [ {
					columnWidth : .5,
