Ext.define('Eway.view.monitor.device.filterManager.MonitorStateConfig', {
	extend : 'Ext.form.Panel',
	alias : 'widget.monitor_device_filtermanager_stateConfig',
	border : false,
	action : 'monitor_device_filtermanager_stateConfig',
	config : {
