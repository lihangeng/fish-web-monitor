Ext.define('Eway.view.parameter.template.LinkedDeviceGrid', {
	alias : 'widget.parameter_linkedDeviceGrid',
	...
	initComponent : function() {
		var store = Ext.create('Eway.store.parameter.template.LinkedDevice');
		store.cleanUrlParam();
		Ext.apply(this, {
			store : store,
			initRegion : true,
