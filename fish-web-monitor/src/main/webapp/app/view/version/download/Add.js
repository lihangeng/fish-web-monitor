...
//    					xtype:'field_versionComboBox'
    					xtype: 'combobox',
    					fieldLabel : EwayLocale.version.downloadVersionId,//'下发版本',
    					name: 'versionId',
    					editable  : false,
                    ...
                    items: [{
			        	...
			        	xtype:'datefield',
			        	fieldLabel:EwayLocale.version.task.actionTime,//'执行时间',
			        	name:'planTime',
			        	disabled: true,
			        	editable: true,
			            format: 'Y-m-d H:i:s',
				...
				items :[{
					...
					title: EwayLocale.version.task.selectDownloadDevice//'选择下发的设备'
				}]
			}]
		  }//end with items
		});
