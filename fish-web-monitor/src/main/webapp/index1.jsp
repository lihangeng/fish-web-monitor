...
<head>
	...
	<link rel="stylesheet" type="text/css" href="ext6/packages/theme-crisp/resources/theme-crisp-all.css" media="all" />
	<link rel="stylesheet" type="text/css" href="ext6/packages/sencha-charts/crisp/charts-all.css" media="all" />
	...
	<script type="text/javascript" src="ext6/packages/theme-crisp/theme-crisp.js"></script>
	<script type="text/javascript" src="ext6/packages/sencha-charts/charts.js"></script>
	...
	<script type="text/javascript">
		...
		if(Ext.String.startsWith(locale,"zh")){
			Ext.Loader.loadScript(Ext.cxtPath+"/ext6/locale/locale-zh_CN.js");
			...
			Ext.Loader.loadScript(Ext.cxtPath+"/ext6/locale/locale-en.js");
	...
	<script type="text/javascript" src="ext6/patch.js"></script>
</head>
