...
TERMINAL_ID VARCHAR(20) COLLATE utf8_bin NOT NULL,//设备终端号
TRANS_DATE INT DEFAULT '0' NOT NULL,//交易时间（精确到日）
TRANS_COUNT INT DEFAULT '0' NOT NULL,	//交易笔数
PRIMARY KEY (ID)
...
ID bigint NOT NULL AUTO_INCREMENT,
TERMINAL_ID VARCHAR(20) COLLATE utf8_bin NOT NULL,//设备终端号
TRANS_DATE INT DEFAULT '0' NOT NULL,//交易时间（精确到月）
TRANS_COUNT INT DEFAULT '0' NOT NULL,	//交易笔数
PRIMARY KEY (ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
