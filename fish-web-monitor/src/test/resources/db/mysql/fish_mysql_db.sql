...
CREATE TABLE SM_PARAM (
  ...
  PARAM_DIS_VALUE  VARCHAR(128) DEFAULT NULL,
...
CREATE TABLE DEV_INFO (
  ...
  VIRTUAL_CODE VARCHAR(25) DEFAULT NULL,
...
CREATE TABLE ATMC_CASH_INIT_BOX (
  ...
  BOX_CURRENCY VARCHAR(10) DEFAULT NULL,
...
CREATE TABLE SM_TRANSACTION_COLOR(
    ID BIGINT(20) NOT NULL AUTO_INCREMENT,
    USER_NAME VARCHAR(20) DEFAULT NULL,
    HOST_RET VARCHAR(20) DEFAULT NULL,
    BACKGROUND_COLOR VARCHAR(20) DEFAULT NULL,
    FONT_COLOR VARCHAR(20) DEFAULT NULL,
    UPDATE_DATETIME VARCHAR(20) DEFAULT NULL,
    REMARK VARCHAR(150) DEFAULT NULL,
    LOCAL_RET VARCHAR(20) DEFAULT NULL,
    LOCAL_BACKGROUND_COLOR VARCHAR(20) DEFAULT NULL,
    LOCAL_FONT_COLOR VARCHAR(20) DEFAULT NULL,
    HOST_RET_DESCRIBE VARCHAR(60) DEFAULT NULL,
    LOCAL_RET_DESCRIBE VARCHAR(60) DEFAULT NULL,
    PRIMARY KEY (ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE DEV_XFS_PROPERTISE (
  ...
  BCR_EXIST CHAR(1) DEFAULT NULL,
  CAM_EXIST CHAR(1) DEFAULT NULL,
  UKD_EXIST CHAR(1) DEFAULT NULL,
  UKR_EXIST CHAR(1) DEFAULT NULL,
  PRIMARY KEY (TERMINAL_ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE DEV_XFS_STATUS (
  ...
  BCR_STATUS VARCHAR(15) DEFAULT NULL,
  BCR_CODE VARCHAR(20) DEFAULT NULL,
  CAM_STATUS VARCHAR(15) DEFAULT NULL,
  CAM_CODE VARCHAR(20) DEFAULT NULL,
  UKD_STATUS VARCHAR(15) DEFAULT NULL,
  UKD_CODE VARCHAR(20) DEFAULT NULL,
  UKR_STATUS VARCHAR(15) DEFAULT NULL,
  UKR_CODE VARCHAR(20) DEFAULT NULL,
  PRIMARY KEY (TERMINAL_ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE VER_TASK(
	...
	DOWNLOAD_TIME         BIGINT DEFAULT 0,
	PRIMARY KEY (ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE ATMC_COMMAND_HIST (
    ID BIGINT(20) NOT NULL AUTO_INCREMENT,
    DATETIME VARCHAR(20) DEFAULT NULL,
    TERMINAL_ID VARCHAR(20) NOT NULL,
    COMMAND_TYPE VARCHAR(40) DEFAULT NULL,
    COMMAND_RESULT VARCHAR(40) DEFAULT NULL,
    HANDLE_PERSON VARCHAR(40) DEFAULT NULL,
    PRIMARY KEY (ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE PARAM_APP_SYSTEM(
  ...
  CONFIG_PATH VARCHAR (128) NOT NULL,
...
CREATE TABLE ATMC_TRANSACTION_DAYS (
	...
	DEV_TYPE_ID BIGINT DEFAULT NULL,
	DEV_TYPE VARCHAR(30) COLLATE utf8_bin NOT NULL,
	TRANS_CODE VARCHAR(20) COLLATE utf8_bin NOT NULL,
	CARD_TYPE VARCHAR(30) COLLATE utf8_bin NOT NULL,
...
(
	...
	CASHIN_VALUE BIGINT(20) DEFAULT 0,
	BILL_VALUE BIGINT(20) DEFAULT 0,
...
CREATE TABLE DEV_CASH_INIT_RULE
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE DEV_TRADING_VOLUME_DAY
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE DEV_TRADING_VOLUME_MONTH
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE etl_fault_week
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
    STAT_DATE  BIGINT(20) DEFAULT NULL,
    OPEN_COUNT BIGINT(20) DEFAULT NULL,
    CLOSE_COUNT BIGINT(20) DEFAULT NULL,
	PRIMARY KEY (ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

CREATE TABLE etl_fault_month
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
    STAT_DATE  BIGINT(20) DEFAULT NULL,
    OPEN_COUNT BIGINT(20) DEFAULT NULL,
...
CREATE TABLE etl_fault_classify_week
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
    STAT_DATE  BIGINT(20) DEFAULT NULL,
    CLASSIFY_ID VARCHAR(10) DEFAULT NULL,
    CLASSIFY_NAME VARCHAR(30) DEFAULT NULL,
    CLASSIFY_COUNT BIGINT(20) DEFAULT NULL,
	PRIMARY KEY (ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

CREATE TABLE etl_fault_classify_month
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
    STAT_DATE  BIGINT(20) DEFAULT NULL,
    CLASSIFY_ID VARCHAR(10) DEFAULT NULL,
...
CREATE TABLE etl_fault_duration_week
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
    STAT_DATE  BIGINT(20) DEFAULT NULL,
    DURATION_ID BIGINT(20) DEFAULT NULL,
    FAULT_COUNT BIGINT(20) DEFAULT NULL,
	PRIMARY KEY (ID)
)ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

CREATE TABLE etl_fault_duration_month
(
	ID BIGINT(20) NOT NULL AUTO_INCREMENT,
    STAT_DATE  BIGINT(20) DEFAULT NULL,
    DURATION_ID BIGINT(20) DEFAULT NULL,
