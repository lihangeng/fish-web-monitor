...
CREATE INDEX IDX_ATMC_TRANSACTION_DAYS_1 ON ATMC_TRANSACTION_DAYS(TERMINAL_ID);
CREATE INDEX IDX_ATMC_TRANSACTION_DAYS_2 ON ATMC_TRANSACTION_DAYS(TRANS_DATE);

CREATE INDEX IDX_ATMC_TRANSACTION_MONTHS_1 ON ATMC_TRANSACTION_MONTHS(TERMINAL_ID);
