...
CREATE INDEX IDX_ATMC_TRANSACTION_DAYS_1 ON ATMC_TRANSACTION_DAYS(VENDOR_NAME);
CREATE INDEX IDX_ATMC_TRANSACTION_DAYS_2 ON ATMC_TRANSACTION_DAYS(TRANS_DATE);

CREATE INDEX IDX_ATMC_TRANSACTION_MONTHS_1 ON ATMC_TRANSACTION_MONTHS(VENDOR_NAME);
CREATE INDEX IDX_ATMC_TRANSACTION_MONTHS_2 ON ATMC_TRANSACTION_MONTHS(TRANS_DATE);
CREATE INDEX IDX_CASE_FAULT_3 ON CASE_FAULT(TERMINAL_ID,FAULT_STATUS);
